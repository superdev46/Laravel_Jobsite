...
/********** UserController *************/
Route::get('donor/profile', 'UserController@myProfile')->name('donor.profile');
Route::put('donor/edit_profile', 'UserController@updateMyProfile')->name('my.profile');
Route::get('view-public-profile/{id}', 'UserController@viewPublicProfile')->name('donor.detail');
...
/**************************************/
Route::get('donor/charities', 'UserController@findCharities')->name('donor.browse_cahrities');
Route::get('donor/charity/{slug}', 'UserController@charityDetail')->name('donor.charity.detail');
//******************************  Donor dashboard  **************************/

Route::get('donor/dashboard', 'UserController@dashboard')->name('donor.dashboard');
Route::get('donor/job/post', 'UserController@createFrontJob')->name('donor.job.post');
Route::get('donor-home', 'UserController@index')->name('donor.home');
/*************************************/