...
/********** CampaignController *************/
include_once($real_path .'campaign.php');

/********** ContactController *************/
include_once($real_path .'contact.php');
/********** CompanyController *************/
include_once($real_path .'charity.php');
/********** AjaxController *************/
include_once($real_path .'ajax.php');
/********** UserController *************/
include_once($real_path .'donor.php');

/********** User Auth *************/
Auth::routes();

/********** Charity Auth *************/
include_once($real_path .'charity_auth.php');

include_once($real_path .'donor_auth.php');
