        ...
        <input type="hidden" name="search" value="{{Request::get('search', '')}}"/>
          ...
          <div class="widget">
			...
			@endphp
                ...
                {{$jobTitle}} <span>{{App\Campaign::countNumCampaigns('title', $jobTitle)}}</span> </li>
          ...
          <div class="widget">
			...
			@endphp
              <li>
                ...
                {{$country->country}} <span>{{App\Campaign::countNumCampaigns('country_id', $country->country_id)}}</span> </li>
              @endif
          @endforeach
          @endif
              </ul>
          ...
          <div class="widget">
			...
			@endphp
              <li>
                ...
                {{$state->state}} <span>{{App\Campaign::countNumCampaigns('state_id', $state->state_id)}}</span> </li>
              @endif
          @endforeach
          @endif
              </ul>
          ...
          <div class="widget">
			...
			@endphp
              <li>
                ...
                {{$city->city}} <span>{{App\Campaign::countNumCampaigns('city_id', $city->city_id)}}</span> </li>
              @endif
          @endforeach
          @endif
              </ul>
          ...
          <div class="widget">
			...
			@endphp
              <li>
                ...
                {{$jobExperience->job_experience}} <span>{{App\Campaign::countNumCampaigns('job_experience_id', $jobExperience->job_experience_id)}}</span> </li>
              @endif
          @endforeach
          @endif
              </ul>
          ...
          <div class="widget">
			...
			@endphp
              <li>
                ...
                {{$jobType->job_type}} <span>{{App\Campaign::countNumCampaigns('job_type_id', $jobType->job_type_id)}}</span> </li>
              @endif
          @endforeach
          @endif
              </ul>
          ...
          <div class="widget">
			...
			@endphp
              <li>
                ...
                {{$jobShift->job_shift}} <span>{{App\Campaign::countNumCampaigns('job_shift_id', $jobShift->job_shift_id)}}</span> </li>
              @endif
          @endforeach
          @endif
              </ul>
          ...
          <div class="widget">
            ...
            <li>
                ...
                {{$careerLevel->career_level}} <span>{{App\Campaign::countNumCampaigns('career_level_id', $careerLevel->career_level_id)}}</span> </li>
              @endif
          @endforeach
          @endif
              </ul>
          ...
          <div class="widget">
			...
			@endphp
              <li>
                ...
                {{$degreeLevel->degree_level}} <span>{{App\Campaign::countNumCampaigns('degree_level_id', $degreeLevel->degree_level_id)}}</span> </li>
              @endif
          @endforeach
          @endif
              </ul>
          ...
          <div class="widget">
			...
			@endphp
              <li>
                ...
                {{$gender->gender}} <span>{{App\Campaign::countNumCampaigns('gender_id', $gender->gender_id)}}</span> </li>
              @endif
          @endforeach
          @endif
              </ul>
          ...
          <div class="widget">
			...
			@endphp
              <li>
                ...
                {{$industry->industry}} <span>{{App\Campaign::countNumCampaigns('industry_id', $industry->id)}}</span> </li>
              @endif
          @endforeach
          @endif
              </ul>
          ...
          <div class="widget">
			...
			@endphp
              <li>
                ...
                {{$jobSkill->job_skill}} <span>{{App\Campaign::countNumCampaigns('job_skill_id', $jobSkill->job_skill_id)}}</span> </li>
              @endif
          @endforeach
          @endif
              </ul>
          ...
          <div class="widget">
			...
			@endphp
              <li>
                ...
                {{$functionalArea->functional_area}} <span>{{App\Campaign::countNumCampaigns('functional_area_id', $functionalArea->functional_area_id)}}</span>
              </li>                
          @endif
          @endforeach
          @endif
          ...
          <div class="widget">
            ...
            <ul class="optionlist view_more_ul">
              ...
              @php
              $company = App\Charity::where('id','=',$company_id)->active()->first();
              @endphp
              @if(null !== $company)
              @php
			...
			@endphp
              <li>
                ...
                {{$company->name}} <span>{{App\Campaign::countNumCampaigns('company_id', $company->id)}}</span> </li>
              @endif
          @endforeach
          @endif
              </ul>
