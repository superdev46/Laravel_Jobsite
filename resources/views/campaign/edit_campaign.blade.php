        ...
        <div class="dashboard-headline">
          ...
          <nav id="breadcrumbs" class="dark">
            <ul>
              ...
              <li>Edit a Campaign</li>
            </ul>
          </nav>
        </div>
    
        @if(isset($campaign))
        {!! Form::model($campaign, array('method' => 'put', 'route' => array('update.front.campaign', $campaign->id), 'class' => 'form')) !!}
        ...
        <div class="row padding-bottom-30">
          ...
          <div class="col-xl-12">
            <div class="dashboard-box margin-top-0">
              ...
              <!-- Headline -->
              <div class="headline">
                <h3><i class="icon-feather-folder-plus"></i> Edit a Campaign</h3>
              </div>
                ...
                <div class="row">
                  ...
                  <div class="col-xl-4">
                    <div class="submit-field {!! APFrmErrHelp::hasError($errors, 'job_type_id') !!}">
                      <h5>Campaign Type</h5>
                      {!! Form::select('job_type_id', ['' => __('Select Job Type')]+$jobTypes, null, array('class'=>'selectpicker with-border', 'id'=>'job_type_id')) !!}
                  ...
                  <div class="col-xl-4">
                    <div class="submit-field {!! APFrmErrHelp::hasError($errors, 'functional_area_id') !!}">
                      ...
                      {!! Form::select('functional_area_id', ['' => __('Select Functional Area')]+$functionalAreas, null, array('class'=>'selectpicker with-border', 'id'=>'functional_area_id')) !!}
                  ...
                  <div class="col-xl-4">
                    <div class="submit-field {!! APFrmErrHelp::hasError($errors, 'country_id') !!}" id="country_id_div"> 
                      <h5>Country</h5>
                      <span>
                      {!! Form::select('country_id', ['' => __('Select Country')]+$countries, old('country_id', (isset($job))? $job->country_id:$siteSetting->default_country_id), array('class'=>'selectpicker with-border', 'id'=>'country_id')) !!}
                  ...
                  <div class="col-xl-4">
                    <div class="submit-field {!! APFrmErrHelp::hasError($errors, 'state_id') !!}" id="state_id_div"> 
                      ...
                      <span id="default_state_dd">
                        {!! Form::select('state_id', ['' => __('Select State')], null, array('class'=>'selectpicker with-border', 'id'=>'state_id')) !!} 
                  ...
                  <div class="col-xl-4">
                    <div class="submit-field {!! APFrmErrHelp::hasError($errors, 'city_id') !!}" id="city_id_div"> 
                      ...
                      {!! Form::select('city_id', ['' => __('Select City')], null, array('class'=>'selectpicker with-border', 'id'=>'city_id')) !!} 
                    ...
                    <div class="submit-field">
                      ...
                      <div class="input-with-icon">
                        <div id="autocomplete-container">
                          {!! Form::text('location', null, array('class'=>'with-border', 'id'=>'autocomplete-input', 'placeholder'=>__('Type Address'))) !!}
                ...
                <div class="col-xl-4">
                  ...
                  <div class="col-xl-12">
                    <div class="submit-field">
                      ...
                      {!! Form::textarea('description', null, array('class'=>'with-border', 'cols'=>"30", 'rows'=>"8", 'maxlength'=>"200", 'id'=>'long_description', 'placeholder'=>__('Long description'))) !!}
          ...
          <div class="col-xl-12">
            <button type="submit" class="button ripple-effect big margin-top-30 right-side"><i class="icon-feather-plus"></i> Update Campaign</button>
          </div>
