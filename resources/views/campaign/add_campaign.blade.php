  ...
  <div class="dashboard-container">
    ...
    <div class="dashboard-content-container" data-simplebar>
      <div class="dashboard-content-inner" >
        ...
        {!! Form::open(array('method' => 'post', 'route' => array('store.front.campaign'), 'class' => 'form')) !!}
        ...
        <div class="row padding-bottom-30">
          ...
          <div class="col-xl-12">
            <button type="submit" class="button ripple-effect big margin-top-30 right-side"><i class="icon-feather-plus"></i> Post Campaign</button>
          </div>
