...
<div id="wrapper">
  ...
  <!-- Titlebar
  ================================================== -->
  <div class="single-page-header" data-background-image="/assets/images/single-company.jpg">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="single-page-header-inner">
            <div class="left-side">
              ...
              <h3> {{$charity->organization_name}} <span>{{$charity->getIndustry("industry")}}</span></h3>
                <ul>
                  {{-- <li><div class="star-rating" data-rating="4.9"></div></li> --}}
                  <li> United {{$charity->getlocation()}}</li>
    ...
    <div class="row">
      ...
      <div class="col-xl-8 col-lg-8 content-right-offset">
        ...
        <div class="single-page-section">
          <h3 class="margin-bottom-25">About Charity</h3>
          <p>
      ...
      <div class="col-xl-4 col-lg-4">
        <div class="sidebar-container">
          ...
          <div class="sidebar-widget">
            <h3>Website</h3>
          <a href="{{$charity->website}}" target="_blank">{{$charity->website}}</a>
          </div>
