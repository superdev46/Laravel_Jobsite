      ...
      <div class="row"> @include('includes.job_list_side_bar')
        ...
        <div class="col-md-6 col-sm-12"> 
          ...
          <ul class="searchList">
            ...
            @php $company = $job->getDonor(); @endphp
            ...
            <li>
              ...
              <div class="row">
                ...
                <div class="col-md-8 col-sm-8">
                  ...
                  <div class="jobimg">{{$company->printUserImage()}}</div>

                  <div class="jobinfo">

                    <h3><a href="{{route('job.detail', [$job->slug])}}" title="{{$job->title}}">{{$job->title}}</a></h3>

                    <div class="companyName"><a href="{{route('donor.detail', $job->donor_id)}}" title="{{$company->name}}">{{$company->name}}</a></div>
