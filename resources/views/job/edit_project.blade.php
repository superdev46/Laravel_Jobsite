  ...
  <div class="dashboard-container">
    ...
    <div class="dashboard-content-container" data-simplebar>
      <div class="dashboard-content-inner" >
        ...
        @if(isset($job))
        {!! Form::model($job, array('method' => 'put', 'route' => array('update.front.project', $job->id), 'class' => 'form')) !!}
        ...
        <div class="row padding-bottom-30">
                  ...
                  <div class="col-xl-4">
                    <div class="submit-field">
                      ...
                      <div class="submit-field {!! APFrmErrHelp::hasError($errors, 'skills') !!}">
                        ...
                        @endphp
                        {!! Form::select('skills[]', $jobSkills, $skills, array('class'=>'selectpicker default', 'id'=>'skills', 'multiple'=>'multiple')) !!}
          ...
          <div class="col-xl-12">
            <button type="submit" class="button ripple-effect big margin-top-30 right-side"><i class="icon-feather-plus"></i> Update Project</button>
          </div>
