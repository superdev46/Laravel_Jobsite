        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="companyinfo">
              ...
              <div class="companylogo"><a href="{{route('charity.donor.profile',$donor->id)}}">{{$donor->printUserImage()}}</a></div>

              <div class="title"><a href="{{route('charity.donor.profile',$donor->id)}}">{{$donor->name}}</a></div>

              <div class="ptext">{{$donor->getLocation()}}</div>

              <div class="opening">

              <a href="{{route('charity.donor.profile',$donor->id)}}">

              {{-- {{App\Charity::countNumJobs('company_id', $donor->id)}} {{__('Current Jobs Openings')}} --}}
        ...
        <div class="relatedJobs">
          ...
          <ul class="searchList">
            ...
            @if(isset($relatedJobs) && count($relatedJobs))
              ...
              <?php $relatedJobCompany = $relatedJob->getDonor();?>
            ...
            <div class="row">
              ...
              <div class="col-md-8 col-sm-8">
                ...
                <div class="jobimg"><a href="{{route('job.detail', [$relatedJob->slug])}}" title="{{$relatedJob->title}}">
                    ...
                    {{$relatedJobCompany->printUserImage()}}
                ...
                <div class="jobinfo">
                  ...
                  <div class="companyName"><a href="{{route('charity.donor.profile', $relatedJobCompany->id)}}" title="{{$relatedJobCompany->name}}">{{$relatedJobCompany->name}}</a></div>
          ...
          <div class="jobdetail">
            ...
            <ul class="jbdetail">
              ...
              <li class="row">
                ...
                <div class="col-md-8 col-xs-7"><a href="{{route('charity.donor.profile', $donor->id)}}">{{$donor->name}}</a></div>
