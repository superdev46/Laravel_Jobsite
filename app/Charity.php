...
class Charity extends Authenticatable
{
	...
	public function printCharityImage($width = 0, $height = 0)
    {
    ...
    {
        return $this->hasMany('App\Job', 'charity_id', 'id');
    }
	
	public function openJobs()
    {
        return Job::where('charity_id', '=', $this->id)->notExpire();
    }
	...
	{
		return CompanyMessage::where('charity_id','=', $this->id)->where('is_read','=', 0)->count();
	}
	...
	public function isFavouriteApplicant($user_id, $job_id, $charity_id)
    {
        $return = false;
