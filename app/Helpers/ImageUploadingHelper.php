...
class ImageUploadingHelper
{
    ...
    public static function print_image($image_path, $width = 0, $height = 0, $default_image = '/admin_assets/no-image.png', $alt_title_txt = '', $class = '')
    {
        echo self::get_image($image_path, $width, $height, $default_image, $alt_title_txt, $class);
    }
	...
	public static function get_image($image_path, $width = 0, $height = 0, $default_image = '/admin_assets/no-image.png', $alt_title_txt = '', $class= '' )
    {		
        $dimensions = '';
        if ($width > 0 && $height > 0) {
        ...
        if (!empty($image_path) && file_exists(ImageUploadingHelper::real_public_path() . $image_path)) {
            return '<img src="' . ImageUploadingHelper::public_path() . $image_path . '" ' . $dimensions . ' alt="' . $alt_title_txt . '" title="' . $alt_title_txt . '" class="'.$class.'">';
        } else {
