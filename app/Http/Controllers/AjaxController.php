...
class AjaxController extends Controller
{
	...
	public function filterLangStates(Request $request)
    {
        ...
        // $dd = Form::select('state_id', ['' => __('Select State')] + $states, $state_id, array('id' => $new_state_id, 'class' => 'selectpicker with-border'));
        // echo $dd;
    }
    ...
    public function filterLangCities(Request $request)
    {
        ...
        // $dd = Form::select('city_id', ['' => 'Select City'] + $cities, $city_id, array('id' => 'city_id', 'class' => 'selectpicker with-border'));
        // echo $dd;
    }
